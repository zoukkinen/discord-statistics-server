...
export class Database {
    ...
    public async getTopGamesInRange(startDate: string, endDate: string, limit?: number, eventId?: number): Promise<{game_name: string, total_sessions: number, total_minutes: number, avg_minutes: number}[]> {
    ...
    public async createEvent(event: Omit<Event, 'id' | 'createdAt' | 'updatedAt'>): Promise<Event> {
    ...
    public async updateEvent(id: number, updates: Partial<Event>): Promise<Event> {
